        ...
        <section id="proof" className="[background:#fff] [padding:72px_24px]">
          <div className="[max-width:672px] [margin:0_auto]">
            <div className="[text-align:center] [margin-bottom:36px]">
              ...
              <h2 className="[margin:0_0_14px] [font-size:clamp(24px,3vw,36px)] [line-height:1.25] [font-weight:900] [font-family:Nunito,sans-serif] [color:#151515]">Metode Kami Berhasil Membuat<br /><font color="#7c3aed"><span className="[font-size:26.46px]">Ribuan Alumni Kami Capai TOEFL 500+&nbsp;</span></font></h2>
