                    ...
                    {flashVisible ? (
                        <>
                            <a
                                ...
                                id="urgency-banner"
                                href="#pricing"
                                className="[position:sticky] [top:0] [z-index:51] [display:flex] [flex-wrap:nowrap] [align-items:center] [justify-content:center] [gap:8px] [overflow:hidden] [padding:8px_12px] [text-align:center] [font-family:'Instrument_Sans',sans-serif] [white-space:nowrap] [background:#C10707] [text-decoration:none] max-[500px]:[padding:10px_12px]"
                            >
                                <span
                                    id="banner-full"
